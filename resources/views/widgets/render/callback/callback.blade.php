      ...
      <div class="panel-body">
        <fieldset>
            <form   id="callbackosnovnoe"  name="callbackosnovnoe" >
                    ...
                    <div class="row">
                       ...
                       {!! $status_checkbox_metrika !!}
                            <div class="checkbox checkbox-switchery">
                                <label>
                                    <input type="hidden" name="dop_form" value="0">
                                    <input type="checkbox" class="switchery" id="active_osn"   value="1"
                                           name="active_osn" @if($widget_vk->active_osn==1) checked="checked"
                                           @endif  data-id="{{$widget->id}}" >Виджет Колбека

                                </label>
                            </div>
                            <div class="checkbox checkbox-switchery row" style="margin: 20px">
                                <label class="col-lg-7 control-label">Время открытия в секундах:</label>
                                <div class="col-md-5">
                                    <input type="text" class="form-control" name="timer" id="callback_wtimer"
                                           value="{{$widget_vk->timer}}">
                        ...
                        <div class="col-md-6">
                            <p>Номер</p>
                            <div id="block_0" @if ($widget_vk->callback_tip==0) style="display:block" @endif><p>
                ...
                <div class="checkbox checkbox-switchery">
                    <label>
                        <input type="hidden" name="active_form" value="0">
                        <input type="checkbox" class="switchery" id="active_form"  onclick="show_tab('active_form')" value="1"
                               name="active_form" @if($widget_vk->active_form==1) checked="checked"
                               @endif  data-id="{{$widget->id}}" >Отслеживание форм
                ...
                <div class="checkbox checkbox-switchery">
                    <label>
                        <input type="hidden" name="form_callback" value="0">
                        <input type="checkbox" class="switchery" id="form_callback"   value="1"
                               name="form_callback" @if($widget_vk->form_callback==1) checked="checked"
                               @endif  data-id="{{$widget->id}}" >Обратный звонок с форм
                ...
                <div class="checkbox checkbox-switchery">
                    <label>
                        <input type="hidden" name="dop_form" value="0">
                        <input type="checkbox" class="switchery" id="dop_form"   value="1"
                               name="dop_form" @if($widget_vk->dop_form==1) checked="checked"
                               @endif  data-id="{{$widget->id}}" >Форма заявки

                    </label>
                </div>
                <div class="checkbox checkbox-switchery">
                    <label>
                        <input type="hidden" name="social_on" value="0">
                        <input type="checkbox" class="switchery" id="social_on"   value="1"
                               name="social_on" @if($widget_vk->social_on==1) checked="checked"
                               @endif  data-id="{{$widget->id}}" >Соц ссылки

                    </label>
                </div>
                <div class="checkbox checkbox-switchery">
                    <label>
                        <input type="hidden" name="callbach_who_call_first" value="0">
                        <input type="checkbox" class="switchery" id="callbach_who_call_first"   value="1"
                               name="callbach_who_call_first" @if(auth()->user()->getglobalsetting->where('skey','callbach_who_call_first')->first()->value==1) checked="checked"
                               @endif  data-id="{{$widget->id}}" >Звонить клиенту первому

                    </label>
                </div>
                <div class="checkbox checkbox-switchery">
                    <label>
                        <input type="hidden" name="callbach_who_man_wooman" value="0">
                        <input type="checkbox" class="switchery" id="callbach_who_man_wooman"   value="1"
                               name="callbach_who_man_wooman" @if(auth()->user()->getglobalsetting->where('skey','callbach_who_man_wooman')->first()->value==1) checked="checked"
                               @endif  data-id="{{$widget->id}}" >Женский/Мужской голос(OFF-женский)
...
<div class="neiros-sip-show col-xs-12" style="display:none">Оплата за минуты не взымается. По указанным ниже параметрам можно подключить<br> soft phone или Вашу АТС. Звонки будут переводится на подключенное устройство.</div>
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label">Включить колбек с формы:</label>
                            <div class="col-lg-9">
                                <input type="hidden" name="callback_form_form"value="0">
                                <input type="checkbox" name="callback_form_form" id="callback"
                                       @if($widget_js->params['callback']==1) checked @endif  value="1">
