...
<div id="myModal_sett_21" class="modal fade ClientInfoModal lids-neiros integration___modal WidgetModal">
                                        ...
                                        <div class="col-md-12">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" value=" https://cloud.neiros.ru/api/jivosite/webhook/{{$site->hash}}" class="form-control" style="width: 100%">
