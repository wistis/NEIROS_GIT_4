<div class="col-md-3 integration-item">
    <div class="single-cases-card" >
        <div class="card-image"><a data-toggle="modal" data-target="#myModal_sett_27"><img alt="" src="/images/Tilda_Logo.png" draggable="false" class="img-responsive"></a>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 block-descr">
                        <div class="col-sm-6"><div class="img-block-left"><img width="100%" src="/images/Tilda_Logo.png"></div></div>
                        <div class="col-sm-6">
