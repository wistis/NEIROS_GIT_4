...
<div id="neiros__chat_before_iframe" class="" style="display:none;">
    ...
    function addIframe(){
        ...
        list.innerHTML = '<div class="neiros__closet-icon-modal"><img  src="https://cloud.neiros.ru/cdn/v1/callback/images/icons/closet-icon-modal-callback.PNG" alt=""></div><iframe id="neiros__chat_iframe" src="https://cloud.neiros.ru/xcallback/'+divise+'/'+sbjs.get.first_add.hash+'/'+CBU_GLOBAL.config.widget.key+'/?promo='+sbjs.get.promo.code+'&'+divise+'"  ></iframe><div class="neiros__copiright_new2">Виджет заряжен Neuron</div>'
    ...
    function addIframe_new(type,stat){
        ...
        list = document.querySelector("#neiros__chat_before_iframe");
        list.innerHTML = '<div class="neiros__closet-icon-modal '+type_new+'">'+content_new+'</div><iframe id="neiros__chat_iframe" src="https://cloud.neiros.ru/xcallback/'+divise+'/'+sbjs.get.first_add.hash+'/'+CBU_GLOBAL.config.widget.key+'/?promo='+sbjs.get.promo.code+'&type='+type+'&'+divise+'"  ></iframe><div class="neiros__copiright_new2">Виджет заряжен Neuron</div>'
...
/*                addIframe_new('phone', '0');
        ...
        list = document.querySelector("#neiros__chat_before_iframe");
        list.innerHTML = '<div class="neiros__closet-icon-modal"><img  src="images/icons/closet-icon-modal.PNG" alt=""></div><iframe id="neiros__chat_iframe" src="callback.php?'+divise+'"  ></iframe>';*/
    }
