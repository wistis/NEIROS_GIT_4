        ...
        <div class="panel panel-default">
           ...
           <form method="post" action="">
               ...
               <div class="form-group">
                   ...
                   <div class="col-lg-9">
                       <input type="text" class="form-control" name="name" id="name"   required value="{{$subject->name}}">
                   </div>
               </div>
               <div class="form-group">
                   ...
                   <div class="col-lg-9">
                       <select name="agents[]" multiple class="form-control">
                           ...
                           @foreach($users as $user)
                               <option  value="{{$user->id}}" @if(count($subject->agents)>0)
                                   @if(in_array($user->id,$subject->agents->pluck('id')->toArray())) selected @endif
