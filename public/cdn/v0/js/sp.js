...
function placeData(sb) {
    ...
    var body = 'first=' + encodeURIComponent(JSON.stringify(sb.first)) +
        ...
        '&olev_phone_track=' + encodeURIComponent(JSON.stringify(''))+
...
//    xhr.onreadystatechange = ...;
    ...
    xhr.send(body);
/*<div class="gasend-promo-wrap"><div class="gasend-promo-text">Промокод</div><div class="gasend-promo">61148</div></div>*/

    var e = document.createElement("div");
    e.className = "wrp_cbu", e.innerHTML = '<div id=cbu_btn class="cbu-phone cbu-blue cbu-show">' +
        ' <div class="gasend-promo-text">Промокод</div><div>'+sb.promo.code+'</div> </div>', document.body.appendChild(e)
}
