...
$(function() {
    ...
    generateBarChart("#members-online", 24, 70, true, "elastic", 1200, 70, "rgba(255,255,255,0.5)", "members");
	generateBarChart("#members-online2", 24, 70, true, "elastic", 1200, 70, "rgba(255,255,255,0.5)", "members");
    ...
    sparkline("#server-load", "area", 30, 70, "basis", 750, 2000, "rgba(255,255,255,0.5)");
    ...
    dailyRevenue('#today-revenue', 70); // initialize chart
